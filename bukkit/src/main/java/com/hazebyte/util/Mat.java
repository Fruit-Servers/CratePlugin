...
public enum Mat {
    ...
    BEETROOT("BEETROOT", 0), // PLACED AFTER BEETROOTS for 1.13
    BELL("WOOD", 0),
    ...
    BROWN_MUSHROOM_BLOCK("BROWN_MUSHROOM", 0), // PLACED AFTER BLOCK FOR 1.13
    ...
    CAKE("CAKE", 0),
    CARROTS("CARROT_ITEM", 0),
    CARROT("CARROT_ITEM", 0), // Placed after CARROTS so 1.13 parsese CARROT from CARROT_ITEM
    CARTOGRAPHY_TABLE("WOOD", 0),
    ...
    CREEPER_WALL_HEAD("SKULL_ITEM", 0),
    ...
    END_STONE_BRICK_SLAB("END_BRICKS", 0),
    END_STONE_BRICK_STAIRS("END_BRICKS", 0),
    END_STONE_BRICK_WALL("END_BRICKS", 0),
    ...
    GRANITE("STONE", 1),
    GRASS_BLOCK("GRASS", 0),
    GRASS("GRASS", 0), // PLACED AFTER GRASS_BLOCK for 1.13
    ...
    LILY_OF_THE_VALLEY("WATER_LILY", 0),
    ...
    MOSSY_COBBLESTON_STAIRS("STONE", 0),
    ...
    NETHER_BRICK("NETHER_BRICK", 0), // PLACED AFTER FOR 1.13
    ...
    POLISHED_ANDESITE_WALL("STONE", 0),
    POLISHED_DIORITE("STONE", 4),
    POLISHED_DIORITE_SLAB("STONE", 0),
    POLISHED_DIORITE_STAIRS("STONE", 0),
    POLISHED_DIORITE_WALL("STONE", 0),
    POLISHED_GRANITE("STONE", 2),
    POLISHED_GRANITE_SLAB("STONE", 0),
    POLISHED_GRANITE_STAIRS("STONE", 0),
    POLISHED_GRANITE_WALL("STONE", 0),
    POPPED_CHORUS_FRUIT("CHORUS_FRUIT_POPPED", 0),
    POPPY("RED_ROSE", 0),
    PORKCHOP("PORK", 0),
    POTATOES("POTATO_ITEM", 0),
    POTATO("POTATO_ITEM", 0), // Placed after POTATOES so POTATO is parsed instead of POTATOES
    POTION("POTION", 0),
    POTTED_ACACIA_SAPLING("FLOWER_POT_ITEM", 0),
    POTTED_ALLIUM("FLOWER_POT_ITEM", 0),
    POTTED_AZURE_BLUET("FLOWER_POT_ITEM", 0),
    POTTED_BAMBOO("FLOWER_POT_ITEM", 0),
    POTTED_BIRCH_SAPLING("FLOWER_POT_ITEM", 0),
    POTTED_BLUE_ORCHID("FLOWER_POT_ITEM", 0),
    POTTED_BROWN_MUSHROOM("FLOWER_POT_ITEM", 0),
    POTTED_CACTUS("FLOWER_POT_ITEM", 0),
    POTTED_CORNFLOWER("FLOWER_POT_ITEM", 0),
    POTTED_DANDELION("FLOWER_POT_ITEM", 0),
    POTTED_DARK_OAK_SAPLING("FLOWER_POT_ITEM", 0),
    POTTED_DEAD_BUSH("FLOWER_POT_ITEM", 0),
    POTTED_FERN("FLOWER_POT_ITEM", 0),
    POTTED_JUNGLE_SAPLING("FLOWER_POT_ITEM", 0),
    POTTED_LILY_OF_THE_VALLEY("FLOWER_POT_ITEM", 0),
    POTTED_OAK_SAPLING("FLOWER_POT_ITEM", 0),
    POTTED_ORANGE_TULIP("FLOWER_POT_ITEM", 0),
    POTTED_OXEYE_DAISY("FLOWER_POT_ITEM", 0),
    POTTED_PINK_TULIP("FLOWER_POT_ITEM", 0),
    POTTED_POPPY("FLOWER_POT_ITEM", 0),
    POTTED_RED_MUSHROOM("FLOWER_POT_ITEM", 0),
    POTTED_RED_TULIP("FLOWER_POT_ITEM", 0),
    POTTED_SPRUCE_SAPLING("FLOWER_POT_ITEM", 0),
    POTTED_WHITE_TULIP("FLOWER_POT_ITEM", 0),
    POTTED_WITHER_ROSE("FLOWER_POT_ITEM", 0),
    ...
    RED_MUSHROOM("RED_MUSHROOM", 0), // PLACED AFTER BLOCK for 1.13
    RED_MUSHROOM_BLOCK("RED_MUSHROOM", 0),
    RED_NETHER_BRICKS("RED_NETHER_BRICK", 0),
    RED_NETHER_BRICK_SLAB("RED_NETHER_BRICK", 0),
    RED_NETHER_BRICK_STAIRS("RED_NETHER_BRICK", 0),
    RED_NETHER_BRICK_WALL("RED_NETHER_BRICK", 0),
    RED_SAND("SAND", 1),
    ...
    SUSPICIOUS_STEW("MUSHROOM_SOUP", 0),
    ...
    ZOMBIE_WALL_HEAD("SKULL_ITEM", 0),
    ;

    private static final String preformat = "%s,%s";
    ...
    Mat(String alternate, int data) {
        this.alternate = alternate;
        this.data = data;
    }

    private static final Map<String, Mat> nameToMat = Maps.newHashMapWithExpectedSize(Mat.values().length);
    private static final Map<Material, Mat> materialToMat = new HashMap<>();

    static {
        /** Maps 1.12 names to 1.13 material names. This should fix compatibility. */
        for (Mat mat : Mat.values()) {
            String key = String.format(preformat, mat.alternate, mat.data);
            // Server versions that are less than 1.13 should have these mappings.
            if (!CorePlugin.getPlugin().getServerVersion().gte(ServerVersion.v1_13_R1)) {
                // "TERRACOTTA,0" => WHITE_TERRACOTA
                nameToMat.put(key, mat);
            }
            // "WHITE_TERRACOTTA" => WHITE_TERRACOTA
            nameToMat.put(mat.name(), mat);
        }
        /** Maps materials to mats */
        for (Mat mat : Mat.values()) {
            Material material;
            if (CorePlugin.getPlugin().getServerVersion().gte(ServerVersion.v1_13_R1)) {
                material = Material.matchMaterial(mat.name());
            } else {
                material = Material.matchMaterial(mat.alternate);
            }
            if (material != null) materialToMat.put(material, mat);
        }
    }
    ...
    public Material toMaterial() {
        ...
        if (CorePlugin.getPlugin().getServerVersion().isMockServer()
                || CorePlugin.getPlugin().getServerVersion().gte(ServerVersion.v1_13_R1)) {
            material = Material.matchMaterial(this.name());
        } else {
    ...
    public boolean isSimilar(ItemStack item) {
        if (CorePlugin.getPlugin().getServerVersion().gte(ServerVersion.v1_13_R1)) {
            return item.getType() == this.toMaterial();
        }

        if (item.getType() != this.toMaterial()) {
            return false;
        }

        // If it is an damageable item, we don't have to check for data values.
        if (from(item.getType()).isDamageable()) {
            return true;
        }

        return (int) item.getData().getData() == this.data;
    }

    public static Mat from(String name) {
        if (name.contains(":")) {
            ...
            return from(name, (byte) 0);
        }
    }

    public static Mat from(String name, short data) {
        name = name.toUpperCase();
        //        Material material = Material.matchMaterial(name);
        //        Mat initial = materialToMat.get(material);

        String key = String.format(preformat, name, data);
        Mat initial = nameToMat.get(key); // Check with name and data.
        if (initial == null) { // Check with just the name.
            initial = nameToMat.get(name);
        }
        if (initial == null) { // Check with name and default data
            key = String.format(preformat, name, 0);
            initial = nameToMat.get(key);
        }
        return initial;
    }

    public static Mat from(Material material) {
        Mat mat = materialToMat.get(material);
        if (mat == null) {
            mat = from(material.name(), (short) 0);
        }
        return mat;
    }

    public static Mat from(ItemStack item) {
    ...
    public boolean isGlass() {
        return this.toString().contains("GLASS");
    }

    public boolean isGlassPane() {
        return this.toString().contains("GLASS_PANE");
    }
